      ...
      body: Stack(
        children: [
              ...
              child: Consumer(
                builder: (_, ref, _) {
                  ...
                  return GoogleMap(
                   ...
                   markers: googleMapState.selectedMarker != null ? {googleMapState.selectedMarker!} : {},
          ...
          Align(
            ...
            child: Container(
              padding: EdgeInsets.only(left:  20.w, right: 20.w,top: 24.h,bottom: 32.h),
              ...
              builder: (_, ref, _) {
                ...
                return Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(googleMapState.userAddress ?? "No Address Selected",
                            style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontSize: 18.sp),maxLines: 1,
                    ...
                    Utils.primaryButton(onPressed: (){Navigator.pop(context);}, text: "Confirm Location")
                  ],
                );
              }
            ),
