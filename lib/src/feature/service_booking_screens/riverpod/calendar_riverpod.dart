...
final calendarRiverpod = StateNotifierProvider<CalendarRiverpod, CalendarState>((ref)=>CalendarRiverpod());
...
class CalendarRiverpod extends StateNotifier<CalendarState>{
  ...
  void goToPreviousMonth(){
    state = state.copyWith(focusedDay: state.focusedDay!.subtract(const Duration(days: 30),),);
  }

  void goToNextMonth(){
    state = state.copyWith(focusedDay: state.focusedDay!.add(const Duration(days: 30),),);
  }
