              ...
              Row(
                ...
                children: [
                  circleIconButton(
                    ...
                    isActive:
                        !calendarState.focusedDay!.isBefore(DateTime.now()),
                    onTap: () {
                      if (calendarState.focusedDay!.isBefore(DateTime.now()))
                        return;
                  ...
                  Text(
                    "${Utils.monthToString(calendarState.focusedDay!.month)} ${calendarState.focusedDay!.year}",
                  ...
                  circleIconButton(
                    ...
                    onTap:
                        calendarState.focusedDay!.isAfter(
                              DateTime(DateTime.now().year + 1),
                            )
                            ? () {}
                            : calendarNotifier.goToNextMonth,
                    isActive:
                        !calendarState.focusedDay!.isAfter(
                          DateTime(DateTime.now().year + 1),
                        ),
              ...
              TableCalendar(
                ...
                onDaySelected: (selected, focused) {
                  ...
                  ref
                      ...
                      .onPickedDate(pickedDate: selected);
                  debugPrint(
